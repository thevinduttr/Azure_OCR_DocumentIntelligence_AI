    ...
    chat_prompt = [
        {
            ...
            "content": (
                ...
                "- Vehicle Model (also: Vehicle Make, Extract Vehicle Model only)\n"
                ...
                "- Model Year (also: Model Year, Manufacturing Year, Year of Manufacture)\n"
                ...
                "  * If brand is not in known list, fallback: take first word as Make and the rest as Model (apply capitalization: Make = Title case first token, Model = Title case rest). Also dont give a body type or wrong vehicle model as a model.\n"
                ...
                "    - 'BMW	X5-50M/STATION' -> Make='BMW', Model='X5'\n"
                ...
                "- **Dates**: Extract in format shown in document (DD/MM/YYYY or similar). If date Like this '09 October 2025' or 09-oct-2025 or any other date format it need to convert to DD/MM/YYYY format. date need to have numbers. not text \n"
                ...
                "- **License Place Of Issue**: If multiple locations found, choose the one that appears closest to the License Number field and it newed to be a Real Issue Place (Ex :Dubai not like Dubai Licensing Authority) \n\n"
