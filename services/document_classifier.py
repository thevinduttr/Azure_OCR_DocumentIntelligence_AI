    ...
    chat_prompt = [
        {
            ...
            "content": (
                ...
                "- Vehicle Type (also: Veh. Type, Veh Type, Category, Class)\n"
                ...
                "### **VCC Fields**\n"
                "- Vehicle Type (also: Vehicle Type)\n"
                ...
                "- Model (also: Model, Vehicle Model, Model Name)\n"
                "- Chasisi Number (also: Chasisi Number, Chassis Number, VIN, Chasis No, Frame Number)\n"
                ...
                "- Vehicle Make (also: Make, Brand, Manufacturer)\n"
                "- Vehicle Model (also: Model, Model Name)\n"
                "- Origin (also: Country of Origin, Origin, Manufacturing Country)\n"
                "- Vehicle Color (also: Vehicle Color, Color, Colour)\n"
                "- Vehicle Class (also: Vehicle Class, Class, Category, Type)\n"
                "- Vehicle Type (also: Vehicle Type, Type, Category)\n"
                ...
                "- **Make and Model**: Identify separately. Make must be a real, known car brand. "
                "If text contains 'Brand/Model', split on / - . or space. First valid car brand = Make. "
                ...
                "    {\n"
                "      \"page\": 3,\n"
                "      \"Doc Type\": \"Mulkiya Front Document\",\n"
